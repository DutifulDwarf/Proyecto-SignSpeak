        ...
        <div class="container py-5">
            <div class="row gx-5 justify-content-start">
                <div class="col-lg-8 text-center text-lg-start">
                    <h1 class="display-1 text-uppercase text-white mb-lg-4">Contactanos</h1>
                    <p class="fs-4 text-white mb-lg-4">Puedes contactar con nosotros para obtener mas informacion sobre Talking hands</p>
                </div>
            </div>
        </div>
    </div>
                        ...
                        <div class="bg-light mb-2">
                            <div class="d-flex align-items-center mb-2">
                                ...
                                <div class="text-start">
                                    <h6 class="text-uppercase mb-1">Lizeth Fernanda López Delgado</h6>
                                    <span>utp0151553@alumno.utpuebla.edu.mx</span>
                                </div>
                            </div>
                            <div class="d-flex align-items-center mb-2">
                                <i class="bi bi-envelope-open fs-1 text-primary me-3"></i>
                                <div class="text-start">
                                    <h6 class="text-uppercase mb-1">Gabriela Amaro Flores</h6>
                                    <span>utp0148809@alumno.utpuebla.edu.mx</span>
                                </div>
                                </div>
                            <div class="d-flex align-items-center mb-2">
                                <i class="bi bi-phone-vibrate fs-1 text-primary me-3"></i>
                                <div class="text-start">
                                    <h6 class="text-uppercase mb-1">Llamanos al</h6>
                                    <span>+52 22-12-34-56-78</span>
                                </div>
                            </div>
                            <div class="d-flex align-items-center mb-2">
                                ...
                                <div class="text-start">
                                    ...
                                    <span><a href="https://instagram.com/traductor_gl?igshid=YmMyMTA2M2Y=">@traductor_gl</a></span>
                                </div>
                            </div>
                            <div class="d-flex align-items-center mb-2">
                                ...
                                <div class="text-start">
                                    ...
                                    <span><a href="https://www.facebook.com/profile.php?id=100087660801787&mibextid=ZbWKwL">Traductor hands that speak</a></span>
                                </div>
                            </div>
                        </div>
                    </div>
